...
public class QuestionAnswearController implements DispatcherController{
    ...
    public  HttpMessageResponse getById(String appName) throws SQLException, JsonProcessingException {
        return HttpMessage.JsonResponse(QuestionAnswerRepository.getById(appName));
    }

    public HttpMessageResponse updateUser(String appName) throws SQLException, JsonProcessingException {
        return HttpMessage.JsonResponse(QuestionAnswerRepository.update(appName, request.getBody()));
    }

    public HttpMessageResponse addUser() throws SQLException, JsonProcessingException {
        return HttpMessage.JsonResponse(QuestionAnswerRepository.add(request.getBody()));
    }

    public HttpMessageResponse deleteUser(String appName) throws SQLException {
        return HttpMessage.JsonResponse(QuestionAnswerRepository.delete(Integer.parseInt(appName)));
    }

    public HttpMessageResponse viewAll() throws JsonProcessingException {
        return HttpMessage.JsonResponse(QuestionAnswerRepository.getAll());
    }
