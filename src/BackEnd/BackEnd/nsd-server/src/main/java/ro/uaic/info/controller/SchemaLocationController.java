...
import ro.uaic.info.Service.SchemaLocationService;
...
public class SchemaLocationController implements DispatcherController{
    ...
    public static String mapRegex = "/schemaL(.*)";
    private final SchemaLocationService service = new SchemaLocationService();
