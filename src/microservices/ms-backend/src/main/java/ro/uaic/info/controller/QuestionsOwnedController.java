...
import ro.uaic.info.Service.QuestionsOwnedService;

import java.sql.SQLException;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class QuestionsOwnedController implements DispatcherController{
    private HttpMessageRequest request;
    public static String mapRegex = "/owquestions(.*)";
    private final QuestionsOwnedService service = new QuestionsOwnedService();
    ...
    public HttpMessageResponse dispatch(HttpMessageRequest httpRequest) throws HttpMessageNotFoundException {
        ...
        Pattern pattern = Pattern.compile("/owquestions/(.*)");
