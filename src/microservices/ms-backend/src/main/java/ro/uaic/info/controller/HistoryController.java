...
import ro.uaic.info.Service.HistoryService;
...
public class HistoryController implements DispatcherController{
    ...
    public static String mapRegex = "/history(.*)";
    ...
    public HttpMessageResponse updateUser(String appName) throws SQLException, JsonProcessingException {
        return HttpMessage.JsonResponse(service.update(Integer.getInteger(appName), request.getBody()));
    }
